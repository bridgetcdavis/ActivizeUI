...
([
   {
       name: 'accounts',
       prefetch: '/Company/getCompanyCalHistory',
       remote: '/Company/getCompanyCalHistory'
   }
...
function refresh() {
    ...
    $("#companyDailyCalories").html('loading...');
    plotCharts("companyDailyCalories", "/Company/getCompanyCalHistory", plotKPI, {
        metric: $("#metric").val()
    });
