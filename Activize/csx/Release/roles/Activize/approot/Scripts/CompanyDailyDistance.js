...
$(function () {
   ...
   {
       name: 'accounts',
       prefetch: '/Company/getCompanyDistHistory',
       remote: '/Company/getCompanyDistHistory'
   }
...
function refresh() {
    ...
    $("#companyDailyDistance").html('loading...');
    plotCharts("companyDailyDistance", "/Company/getCompanyDistHistory", plotKPI, {
        metric: $("#metric").val()
    });
